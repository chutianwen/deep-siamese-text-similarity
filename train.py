...
inpH = InputHelper()
# print("#"*100, FLAGS.training_files)
...
with tf.Graph().as_default():
	...
	def train_step(x1_batch, x2_batch, y_batch):
		...
		_, step, loss, accuracy, dist, sim, summaries = sess.run(
			[tr_op_set, global_step, siameseModel.loss, siameseModel.accuracy, siameseModel.distance, siameseModel.temp_sim, train_summary_op],
			feed_dict)
